...
def createHashMap():
    for filename in args.files:
        ...
        for node in unit.root.findall(lal.ObjectDecl):
            # print(node.sloc_range, node.text)
        ...
        print("All call expression and params called in the: {}".format(filename))
...
listProva = startEnd(slock_range)
...
# Execution:
replace_strings(filename) # Put_line